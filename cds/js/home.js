  ...
  if(responseComplete){
    ...
    if (numMessages > messageCounterLess) {
      ...
      for(i = 0; i < less.length; i++)
      {
        ...
        if(week >= less[i].startweek && week <= less[i].endweek) {
          if(day == dow) {
            if(jTime >= sLesson && jTime <= eLesson) {
              ...
              noTable = '<tr><th><p>There are no lessons currently.</p></th></tr>';
            }
          }
        }
      }
      $('.lessons').append(table);
      $('.lessons').append(noTable);
  ...
  if(responseComplete){
    ...
    if(numMessages > messageCounterMess) {
      ...
      if (mess[messageCounterMess].type === 'WARN') {
        ...
        var $warn = $("<div class='warn'><div class='row'><div class='column fs_5em center_align margin_top'><div id='heading-warn'></div></div></div><div class='row fs_5em center_align margin_top'><div class='column'><div id='message-warn'></div></div></div><div class='row'><div class='column'></div><div class='column'></div><div class='column'><div id='warn-logo'><img src='" + $imgWarn + "'></div></div></div></div>");
        ...
        var $advi = $("<div class='advi'><div class='row'><div class='column center_align margin_top'><div id='heading-advi'></div></div></div><div class='row heading-advi center_align margin_top'><div class='column'><div id='message-advi' class='body-advi'></div></div></div><div class='row'><div class='column'></div><div class='column'></div><div class='column'><div id='advi-logo'><img src='" + $adviLogo + "'></div></div></div></div>");
        ...
        var $factLogo = mess[messageCounterMess].logo;

        var $fact = $("<div class='fact'><div class='row'><div class='column fs_5em center_align'><div id='heading-fact' class='heading-fact'></div></div></div><div class='row'><div class='column _10'></div><div class='column _8'><div id='message-fact' class='message-fact'></div></div><div class='column _10'></div></div><div class='row'><div class='column'></div><div class='column'></div><div class='column'><div id='logo-fact'><img class='factLogo' src='" + $factLogo + "'></div></div></div></div>");
        ...
        var $congLogo = mess[messageCounterMess].logo;

        var $cong = $("<div class='cong'><div class='row'><div class='column fs_5em center_align'><div id='heading-cong'></div></div></div><div class='row'><div class='column center_align'><div id='message-cong'><img class='imagImg' src='" + $congLogo + "'></div></div></div></div>");
...
function checkDate(sToday, sData, wData, sBreaks ,enBreaks){
    ...
    else
    {
        ...
        else
        {
           ...
           if (sToday < academYr2){
             timeDiff = sToday - academYr1.getTime();
           }
           else{
             timeDiff = sToday - academYr2.getTime();
           }
