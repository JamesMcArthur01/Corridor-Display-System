  ...
  if(responseComplete){
    ...
    if(numMessages > messageCounterMess) {
      ...
      if (mess[messageCounterMess].type === 'WARN') {
        ...
        var $job = $("<div class='job'><div class='row'><div class='column' id='heading-job'></div></div><div class='row'><div class='column'></div><div class='column' id='message-job'></div><div class='column'></div></div><div class='row'><div class='column'></div><div class='column'></div><div class='column' id='logo-job'><img src='" + $imgLogo + "'</div></div></div>");
        ...
        var $imag = $("<div class='imag'><div class='row'><div class='column fs_5em center_align'><div id='heading-imag'></div></div></div><div class='row'><div id='#message-imag' class='column'><img src='" + $imgLogo + "'></div></div></div>");
